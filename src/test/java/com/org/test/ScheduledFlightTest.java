...
public class ScheduledFlightTest {
	/**
	  ...
	  public final void testEquals() throws NullPointerException {
		  Airport airport1= new Airport("A101","Spain","Spain Airport","spain","america");
		  Airport airport2= new Airport("A102","India","IGI Airport","india","america");
		  Flight flight= new Flight(new BigInteger("101"),"C101","M101",200);
		  Schedule schedule= new Schedule(new BigInteger("1"),"12-06-2020","13-06-2020");
		  ScheduledFlight sFlight1 = new ScheduledFlight();
		  assertNotNull(sFlight1);
		  ScheduledFlight sFlight2 = null;
		  ScheduledFlight sFlight3= new ScheduledFlight(new BigInteger("101"),flight,120,schedule,airport1);
		  ScheduledFlight sFlight4= new ScheduledFlight(new BigInteger("101"),flight,120,schedule,airport2);
	  ...
	  public final void testToString() {
		  ...
		  Flight flight= new Flight(new BigInteger("101"),"C101","M101",200);
		  Schedule schedule= new Schedule(new BigInteger("1"),"12-06-2020","13-06-2020");
		  ScheduledFlight sFlight1= new ScheduledFlight(new BigInteger("101"),flight,120,schedule,airport1);
	  ...
	  public final void testScheduledFlight() {
		  ...
		  Schedule schedule= new Schedule(new BigInteger("1"),"12-06-2020","13-06-2020");
		  ScheduledFlight sFlight1= new ScheduledFlight(b1,flight,120,schedule,airport1);
		  assertEquals(b1, sFlight1.getScheduleFlightId());
		  assertEquals(Optional.of(120), sFlight1.getAvailableSeats());
