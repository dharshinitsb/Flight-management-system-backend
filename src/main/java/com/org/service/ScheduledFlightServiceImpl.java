...
public class ScheduledFlightServiceImpl implements ScheduledFlightService {
	...
	public ScheduledFlight modifyScheduledFlight(ScheduledFlight scheduleFlight) {
		...
		Airport airport = airportDao.findById(scheduleFlight.getAirport().getAirportCode()).get();
		updateScheduleFlight.setAvailableSeats(scheduleFlight.getAvailableSeats());
		airport.setSrcAirport(scheduleFlight.getAirport().getSrcAirport());
		airport.setDstnAirport(scheduleFlight.getAirport().getDstnAirport());
